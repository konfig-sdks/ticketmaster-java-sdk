 ...
 * Area
 */
@ApiModel(description = "Area")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Area {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Area
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Area.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null

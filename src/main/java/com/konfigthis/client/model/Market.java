 ...
 * Market
 */
@ApiModel(description = "Market")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Market {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Market
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Market.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null

...
public class Geometry {
  ...
  public Geometry location(Location location) {
  ...
  **/
   ...
   * @return the Geometry instance itself
   */
  public Geometry putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.location, geometry.location)&&
        Objects.equals(this.additionalProperties, geometry.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Geometry
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Geometry.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Geometry>() {
           ...
           public Geometry read(JsonReader in) throws IOException {
             ...
             Geometry instance = thisAdapter.fromJsonTree(jsonObj);

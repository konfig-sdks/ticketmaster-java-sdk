 ...
 * Relationship
 */
@ApiModel(description = "Relationship")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Relationship {
  ...
  **/
  ...
  @ApiModelProperty(value = "The ID of the related entity")
  ...
  public Relationship references(Map<String, String> references) {
  ...
  public Relationship putReferencesItem(String key, String referencesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "sourceName: id", value = "References of this relationship in another system. Reference is the exact same entity")
  ...
  public Relationship source(String source) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The source name of the related entity")
  ...
  public Relationship type(TypeEnum type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, relationship.id) &&
        Objects.equals(this.references, relationship.references) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, references, source, type, additionalProperties);
  }

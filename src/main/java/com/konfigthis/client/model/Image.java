 ...
 * Image
 */
@ApiModel(description = "Image")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Image {
  ...
  **/
  ...
  @ApiModelProperty(value = "Attribution of the image")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "true if the image is not the event's image but a fallbak image")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Aspect ratio of the image")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Public URL of the image")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attribution, fallback, height, ratio, url, width, additionalProperties);
  }

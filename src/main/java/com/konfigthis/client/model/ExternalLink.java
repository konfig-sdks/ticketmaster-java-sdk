 ...
 * ExternalLink
 */
@ApiModel(description = "ExternalLink")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ExternalLink {
  ...
  **/
  ...
  @ApiModelProperty(value = "An external link id is the unique identifier of a resource on a different domain or api")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An external link url is a url that goes to a different domain or api")
   ...
   * @return the ExternalLink instance itself
   */
  public ExternalLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, externalLink.id) &&
        ...
        Objects.equals(this.additionalProperties, externalLink.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExternalLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ExternalLink>() {
           ...
           public ExternalLink read(JsonReader in) throws IOException {
             ...
             ExternalLink instance = thisAdapter.fromJsonTree(jsonObj);

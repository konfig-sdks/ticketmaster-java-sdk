 ...
 * Parking
 */
@ApiModel(description = "Parking")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Parking {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Url to the web page of the parking")
   ...
   * @return the Parking instance itself
   */
  public Parking putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, parking.name) &&
        Objects.equals(this.url, parking.url)&&
        Objects.equals(this.additionalProperties, parking.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Parking
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Parking.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Parking>() {
           ...
           public Parking read(JsonReader in) throws IOException {
             ...
             Parking instance = thisAdapter.fromJsonTree(jsonObj);

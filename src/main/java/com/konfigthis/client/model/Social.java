...
import com.konfigthis.client.model.Twitter;
 ...
 */
@ApiModel(description = "Social networks data")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Social {
  ...
  public Social twitter(Twitter twitter) {
  ...
  **/
   ...
   * @return the Social instance itself
   */
  public Social putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.twitter, social.twitter)&&
        Objects.equals(this.additionalProperties, social.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(twitter, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Social.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("twitter") != null && !jsonObj.get("twitter").isJsonNull()) {
        Twitter.validateJsonObject(jsonObj.getAsJsonObject("twitter"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Social>() {
           ...
           public Social read(JsonReader in) throws IOException {
             ...
             Social instance = thisAdapter.fromJsonTree(jsonObj);

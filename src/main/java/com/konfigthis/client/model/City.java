 ...
 * City
 */
@ApiModel(description = "City")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class City {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!City.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
